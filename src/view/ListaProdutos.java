...
public class ListaProdutos extends javax.swing.JFrame {
    ...
    public ListaProdutos() {
        ...
        List<Produtos> lista = d.listarProdutos();

        String[] nomes = new String[]{"Id", "Descrição", "Quantidade", "Valor"};
        Object dados[][] = new Object[lista.size()][4];

        for (int i = 0; i < lista.size(); i++) {

            dados[i][0] = lista.get(i).getId();
            dados[i][1] = lista.get(i).getNomeProduto();
            dados[i][2] = lista.get(i).getQuantidadeProduto();
            dados[i][3] = lista.get(i).getValorProduto();
        }

        jTable1.setModel(new DefaultTableModel(dados, nomes));
    }
