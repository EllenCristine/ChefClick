...
public class ListaUsuarios extends javax.swing.JFrame {
    ...
    public ListaUsuarios() {
        ...
        List <Usuario> lista = d.listarUsuario();
        
        String[] nomes = new String[]{"Nome completo", "Usuário"};
        Object dados[][] = new Object [lista.size()] [4];
        
        for (int i = 0; i < lista.size(); i++){
            
            dados[i][2] = lista.get(i).getNomeCompletoFunc();
            dados[i][3] = lista.get(i).getNomeUsuario();
        }
